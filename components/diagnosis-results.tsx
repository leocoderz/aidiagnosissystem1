    ...
    return (
      <Card>
        <CardContent className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No Diagnosis Available</h3>
          <p className="text-gray-600">Add symptoms and request diagnosis to see results</p>
        </CardContent>
      </Card>
    )
  }
